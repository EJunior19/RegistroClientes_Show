...
document.getElementById('generarPdf').addEventListener('click', function() {
    ...
    const barrioRef1 = document.getElementById('barrio_ref1').value;
    ...
    const barrioRef2 = document.getElementById('barrio_ref2').value;
    ...
    const barrioRef3 = document.getElementById('barrio_ref3').value;
